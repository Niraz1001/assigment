  ...
  return (
    ...
    <Card className='p-5'>
      <CardBody className='flex gap-2'>
        ...
        <input type='text' placeholder='Full Name' className='bg-white w-full border border-slate-300 py-2 pl-5 rounded-md pr-3 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm'></input>
